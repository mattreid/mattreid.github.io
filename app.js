class RecipeSite {
    ...
    async loadRecipes() {
        try {
            ...
            // Fallback to empty array - no hardcoded recipes
            this.recipes = [];
        }
    }
    ...
    renderRecipeGrid(recipesToRender = this.recipes) {
        ...
        recipesToRender.forEach(recipe => {
            ...
            const imageHtml = recipe.image && recipe.image.startsWith('https://') ? 
                `<img src="${recipe.image}" alt="${recipe.title}" class="recipe-image" onerror="this.parentElement.removeChild(this);">` : '';
